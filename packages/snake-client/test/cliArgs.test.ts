...
// Mirrors packages/bomber-client/test/cliArgs.test.ts, adapted for
// snakewait's flag set (adds --seed for offline determinism, and an
// unknown-flag usage error that bomber's parseArgs never enforced).
